...
import com.dargo.moneytracker.Adapters.IncomeArrayAdapter;
...
public class ShowIncome extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		db = new MoneyDB(this);
        listData = new ArrayList<IncomeData>();
        initView();
        Utilities.showActionBar(this);
        categorySpinner = (Spinner) findViewById(R.id.selectIncCategory);
        categorySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    int arg2, long arg3) 
            {
                ...
                String aSelectedCategory = categorySpinner.getSelectedItem().toString();
        ...
        loadSpinnerData();
    	adView = (AdView) findViewById(R.id.show_income_ad);
	...
	private void initView()
	{
        ...
        View header = getLayoutInflater().inflate(R.layout.show_income_header, null);
        View footer = getLayoutInflater().inflate(R.layout.show_income_footer, null);
	...
	{
		listData.clear();
		Cursor getDataCursor = db.getCategoryPeriodIncome(iStartDate, iEndDate, iCategory);
        if (getDataCursor.moveToFirst())
        {
        	try
        	{
	        	...
	        	{
		        	IncomeData temp = new IncomeData();
		        	temp.id = getDataCursor.getInt(0);
		        	temp.incomeName = getDataCursor.getString(1);
		        	temp.incomeValue = getDataCursor.getDouble(2);
		        	temp.incomeDate = getDataCursor.getString(3);
		        	listData.add(temp);
		        	temp = null;
        ...
        setListAdapter(new IncomeArrayAdapter(this, R.layout.show_income_activity, listData));
	}
	...
	public void showAllIncome(View v)
	{
		TextView aTV = (TextView) findViewById(R.id.ShowWhatIncTV);
		aTV.setText("Show all");

		showList();
	}
	
	public void changeIncPeriod(View v)
	{
		

		Intent intentChangePeriod = new Intent(this, ChangeIncomePeriod.class);
		...
		int aPeriodEndYear = 0, aPeriodEndMonth = 0 , aPeriodEndDay = 0;
		  ...
		  if (requestCode == 1) {
		     ...
		     if(resultCode == RESULT_OK){      
		    	 ...
		    	 aStartDate = String.valueOf(aPeriodBeginYear) + "-" + getProperDate(aPeriodBeginMonth + 1) +  "-" + getProperDate(aPeriodBeginDay);
		    	 aEndDate = String.valueOf(aPeriodEndYear) + "-" + getProperDate(aPeriodEndMonth + 1) +  "-" + getProperDate(aPeriodEndDay);
		    	 
		    	 aTV.setText("Income from " + aStartDate + " to " + aEndDate);
		    	 showList(aStartDate, aEndDate);
	...
	public void deleteIncomeFromList(View view)
    {
