...
public class ChangeExpensePeriod extends Activity
{
	...
	protected void onCreate(Bundle iSavedInstanceState) 
	{
		...
		setContentView(R.layout.change_expense_period);
		Utilities.showActionBar(this);
		adView = (AdView) findViewById(R.id.change_exp_period_ad);
	...
	public void setDate(int iYear, int iMonth, int iDay, int iStartOrEnd)
	{
		...
		case 0: //we set a start date
			...
			Button aButton = (Button) findViewById(R.id.ShowExpFromBut);
		...
		case 1: //we set an end date
			...
			myPeriodEndDay = iDay;
			Button bButton = (Button) findViewById(R.id.ShowExpToBut);
